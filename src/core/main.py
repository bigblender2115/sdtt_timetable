...
def load_rooms():
    ...
    try:
        ...
        print("Warning: Rooms.csv not found in data/ or current directory, using default rooms")
...
def generate_timetable():
    ...
    try:
        ...
        print("Warning: Combined.csv not found in data/ or current directory, using default course data")
    ...
    import os
    output_path = 'output/timetable.xlsx' if os.path.exists('output') else 'timetable.xlsx'
    wb.save(output_path)
